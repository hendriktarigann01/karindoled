            ...
            >
              {currentCategory.items.map((item, index) => {
                const itemWaUrl = getWhatsAppUrl(
                  `Halo ${SITE_CONFIG.name}, saya tertarik dan ingin bertanya mengenai produk "${item.name}".`,
                );
                  ...
                  >
                    ...
                    <div className="relative aspect-[4/3] w-full bg-transparent overflow-hidden">
                      ...
                      <div className="absolute top-4 left-4 right-4 flex justify-between items-start pointer-events-none">
                        ...
                        {item.isSpicy && (
                          <span
                            className="p-1.5 rounded-lg bg-red-100 text-brand-primary shadow-sm flex items-center justify-center"
                            title="Pedas"
                          >
