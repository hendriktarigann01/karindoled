...
export function Navbar() {
  ...
  useEffect(() => {
    const handleScroll = () => {
      ...
      // Hero section track is 500vh (5 * h), starts fading/ending transition at 4.5 * h
      setInHero(window.scrollY < h * 4.5);
    };
  ...
  const isLightHeader = scrolled && inHero && !mobileOpen;
  const logoSrc = SITE_CONFIG.logo;
    ...
    <>
      ...
      <motion.header
        ...
        className={cn(
          ...
          scrolled ? "bg-brand-black backdrop-blur-sm" : "bg-brand-bg",
        )}
      >
              ...
              >
                ...
                <span
                  className={cn(
                    ...
                    isLightHeader ? "bg-white" : "bg-brand-secondary",
                  )}
                />
              </a>
            ))}
